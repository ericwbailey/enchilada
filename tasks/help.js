module.exports = {
    ...
    clean: {
        ...
        build: '[Child Task] Deletes `.build/` and all its files and subfolders.',
        buildImages: '[Child Task] Deletes `.build/images/` and all its files and subfolders.',
        test: '[Child Task] Deletes `.test/` and all its files and subfolders.',
        testImages: '[Child Task] Deletes `.test/images/` and all its files and subfolders.',
        deploy: '[Child Task] Deletes `docs/` and all its files and subfolders.',
        documentation: '[Child Task] Deletes `documentation/` and all its files and subfolders.',
        documentationStyles: '[Child Task] Deletes `documentation/styles/` and all its files and subfolders.'
    },
    document: {
